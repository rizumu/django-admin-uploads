...
VERSION = __import__("admin_uploads").__version__


setup(
    name = "admin-uploads",
    version = VERSION,
    url = "http://django-admin-uploads.readthedocs.org/",
    license = "BSD",
    ...
    package_data = find_package_data("admin_uploads", only_in_packages=False),
    install_requires=[
        "Django>=1.3",
    ],
    classifiers = [
